...
function PageInit(){	
	...
	create_jqGrid("成交查询",{},{"trdid":{"formatter":get_TraType}})
...
function get_CJCXInfo(){
	...
	setIX({"funcid":"L2620125","funcname":'ret_CJCXInfo',"strdate":fmtDt(start),"enddate":fmtDt(end),"custid":User.khh,"fundid":'',
		"currency":'',"stkacc":'',"isscode":'',"prodcode":'',"productid":'',"declid":'',"pagerecnum":'0',"pagecnt":'500'},User.khh)
}
//应答产品信息
