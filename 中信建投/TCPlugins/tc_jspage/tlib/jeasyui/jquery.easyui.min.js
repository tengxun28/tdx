...
$(opts.tools).children().clone().appendTo(_311);//新增修改，防止tab上的小菜单被剪切掉
}
...
$.ajax({type:opts.method,url:opts.url,data:_6c5,dataType:(opts.dataType=="jsonp"?"jsonp":"json"),jsonp:'callback',success:function(data){
_6c6(data);
},error:function(){
